...
define   IRW 0 // internal read , internal write.   
define   XRD 1 // external read , internal write.  
define   XWR 2 // internal read , external write.  
define   XRW 3 // external read , external write.  
