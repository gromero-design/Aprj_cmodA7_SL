...
//			sei;
main1:		nop					;
 			swi		swia		; // swi and nop 
main2:		nop					;
 			swi		sub1		; // swi and nop 
			ldpagv	'h1ff1		; // address page = 1111
 			swi		sub2		; // swi and nop 
			ldpagv	'h2ff2		; // address page = 1111
 			swi		sub3		; // swi and nop 
			ldpagv	'h3ff3		; // address page = 1111
 			swi		sub4		; // swi and nop 
			ldpagv	'h4ff4		; // address page = 1111
 			swi		swia		; // swi and nop 
			ldpagv	'h5ff5		; // address page = 1111
main3:		nop					;
...
@'h0200
sub1:		ldpagv	'h0101		; // address page = 1111
			inc		r8			;
			rti					;
sub2:		ldpagv	'h0202		; // address page = 1111
			inc		r8			;
			rti					;
sub3:		ldpagv	'h0303		; // address page = 1111
			inc		r8			;
			rti					;
sub4:		ldpagv	'h0404		; // address page = 1111
			inc		r8			;
			rti					;
