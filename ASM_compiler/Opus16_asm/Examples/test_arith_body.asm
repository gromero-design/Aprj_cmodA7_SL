...
main:		cli						; // disable interrutps
    ...
    //////////////////////////////////////////////////////////////////////
	// Main Loop
	// ldpag r# is used for debugging with Vivado or Modelsim
    //////////////////////////////////////////////////////////////////////

main_loop:	uport	t9				; // external trigger for scope
			uport	f9				; // clears port bit 0
			ldpv	pD,temp			; // initialize pointer to temp
			jsr		test_arith		; // application routine
			nop						; 
			stop					; // used by Vivado or Modelsim 
			jmp   main_loop			; // as a trigger 
...
zend_code:	// mark the end of code
   ...
   // Temporary storage
temp:	ds	32		; // reserve 10 word places, temporary scratch pad.
