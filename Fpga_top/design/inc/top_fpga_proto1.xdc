...
## Pins 15 and 16 should remain commented if using them as analog inputs
 set_property -dict {PACKAGE_PIN M3  IOSTANDARD LVCMOS33} [get_ports pio_txd_in] ; # Sch=pio[01]
 set_property -dict {PACKAGE_PIN L3  IOSTANDARD LVCMOS33} [get_ports pio_rxd_out]; # Sch=pio[02]
 set_property -dict {PACKAGE_PIN A16 IOSTANDARD LVCMOS33} [get_ports pio_usb_sel]; # Sch=pio[03]
 set_property -dict {PACKAGE_PIN K3  IOSTANDARD LVCMOS33} [get_ports pio_bt_pwr] ; # Sch=pio[04]
...
#set_property -dict {PACKAGE_PIN T1  IOSTANDARD LVCMOS33} [get_ports { pio[24] }]; # Sch=pio[29]
 set_property -dict {PACKAGE_PIN T2  IOSTANDARD LVCMOS33} [get_ports pwm_ch16];    # Sch=pio[30]
 set_property -dict {PACKAGE_PIN U1  IOSTANDARD LVCMOS33} [get_ports pwm_ch15];    # Sch=pio[31]
 set_property -dict {PACKAGE_PIN W2  IOSTANDARD LVCMOS33} [get_ports pwm_ch14];    # Sch=pio[32]
 set_property -dict {PACKAGE_PIN V2  IOSTANDARD LVCMOS33} [get_ports pwm_ch13];    # Sch=pio[33]
 set_property -dict {PACKAGE_PIN W3  IOSTANDARD LVCMOS33} [get_ports pwm_ch12];    # Sch=pio[34]
 set_property -dict {PACKAGE_PIN V3  IOSTANDARD LVCMOS33} [get_ports pwm_ch11];    # Sch=pio[35]
 set_property -dict {PACKAGE_PIN W5  IOSTANDARD LVCMOS33} [get_ports pwm_ch10];    # Sch=pio[36]
 set_property -dict {PACKAGE_PIN V4  IOSTANDARD LVCMOS33} [get_ports pwm_ch9] ;    # Sch=pio[37]
 set_property -dict {PACKAGE_PIN U4  IOSTANDARD LVCMOS33} [get_ports pwm_ch8] ;    # Sch=pio[38]
 set_property -dict {PACKAGE_PIN V5  IOSTANDARD LVCMOS33} [get_ports pwm_ch7] ;    # Sch=pio[39]
 set_property -dict {PACKAGE_PIN W4  IOSTANDARD LVCMOS33} [get_ports pwm_ch6] ;    # Sch=pio[40]
 set_property -dict {PACKAGE_PIN U5  IOSTANDARD LVCMOS33} [get_ports pwm_ch5] ;    # Sch=pio[41]
 set_property -dict {PACKAGE_PIN U2  IOSTANDARD LVCMOS33} [get_ports pwm_ch4] ;    # Sch=pio[42]
 set_property -dict {PACKAGE_PIN W6  IOSTANDARD LVCMOS33} [get_ports pwm_ch3] ;    # Sch=pio[43]
 set_property -dict {PACKAGE_PIN U3  IOSTANDARD LVCMOS33} [get_ports pwm_ch2] ;    # Sch=pio[44]
 set_property -dict {PACKAGE_PIN U7  IOSTANDARD LVCMOS33} [get_ports pwm_ch1] ;    # Sch=pio[45]
 set_property -dict {PACKAGE_PIN W7  IOSTANDARD LVCMOS33} [get_ports blueled] ;    # Sch=pio[46]
 set_property -dict {PACKAGE_PIN U8  IOSTANDARD LVCMOS33} [get_ports redled3] ;    # Sch=pio[47]
 set_property -dict {PACKAGE_PIN V8  IOSTANDARD LVCMOS33} [get_ports redled4] ;    # Sch=pio[48]
