...
## Pins 15 and 16 should remain commented if using them as analog inputs
 set_property -dict {PACKAGE_PIN M3  IOSTANDARD LVCMOS33} [get_ports pwm_ch5]       ; # Sch=pio[01]
 set_property -dict {PACKAGE_PIN L3  IOSTANDARD LVCMOS33} [get_ports pwm_ch6]       ; # Sch=pio[02]
 set_property -dict {PACKAGE_PIN A16 IOSTANDARD LVCMOS33} [get_ports pwm_ch7]       ; # Sch=pio[03]
 set_property -dict {PACKAGE_PIN K3  IOSTANDARD LVCMOS33} [get_ports pwm_ch8]       ; # Sch=pio[04]
 set_property -dict {PACKAGE_PIN C15 IOSTANDARD LVCMOS33} [get_ports pio_txd_in]    ; # Sch=pio[05]
 set_property -dict {PACKAGE_PIN H1  IOSTANDARD LVCMOS33} [get_ports pio_rxd_out]   ; # Sch=pio[06]
 set_property -dict {PACKAGE_PIN A15 IOSTANDARD LVCMOS33} [get_ports pio_bt_pwr]    ; # Sch=pio[07]
...
#set_property -dict {PACKAGE_PIN K2  IOSTANDARD LVCMOS33} [get_ports pio[11]]       ; # Sch=pio[12]
 set_property -dict {PACKAGE_PIN L1  IOSTANDARD LVCMOS33} [get_ports pwm_ch13]      ; # Sch=pio[13]
 set_property -dict {PACKAGE_PIN L2  IOSTANDARD LVCMOS33} [get_ports pwm_ch14]      ; # Sch=pio[14]
# ANALOG                                                                            ; # Sch=pio[15]
# ANALOG                                                                            ; # Sch=pio[16]
 set_property -dict {PACKAGE_PIN M1  IOSTANDARD LVCMOS33} [get_ports pwm_ch15]      ; # Sch=pio[17]
 set_property -dict {PACKAGE_PIN N3  IOSTANDARD LVCMOS33} [get_ports pwm_ch16]      ; # Sch=pio[18]
...
# VCC                                                                               ; # Sch=pio[24]
# GND                                                                               ; # Sch=pio[25]
 set_property -dict {PACKAGE_PIN R3  IOSTANDARD LVCMOS33} [get_ports pwm_ch4]       ; # Sch=pio[26]
 set_property -dict {PACKAGE_PIN T3  IOSTANDARD LVCMOS33} [get_ports pwm_ch3]       ; # Sch=pio[27]
 set_property -dict {PACKAGE_PIN R2  IOSTANDARD LVCMOS33} [get_ports pwm_ch2]       ; # Sch=pio[28]
 set_property -dict {PACKAGE_PIN T1  IOSTANDARD LVCMOS33} [get_ports pwm_ch1]       ; # Sch=pio[29]
 set_property -dict {PACKAGE_PIN T2  IOSTANDARD LVCMOS33} [get_ports pwm_ch12]      ; # Sch=pio[30]
 set_property -dict {PACKAGE_PIN U1  IOSTANDARD LVCMOS33} [get_ports pwm_ch11]      ; # Sch=pio[31]
 set_property -dict {PACKAGE_PIN W2  IOSTANDARD LVCMOS33} [get_ports pwm_ch10]      ; # Sch=pio[32]
 set_property -dict {PACKAGE_PIN V2  IOSTANDARD LVCMOS33} [get_ports pwm_ch9]       ; # Sch=pio[33]
 set_property -dict {PACKAGE_PIN W3  IOSTANDARD LVCMOS33} [get_ports redled1]       ; # Sch=pio[34]
 set_property -dict {PACKAGE_PIN V3  IOSTANDARD LVCMOS33} [get_ports redled2]       ; # Sch=pio[35]
 set_property -dict {PACKAGE_PIN W5  IOSTANDARD LVCMOS33} [get_ports redled3]       ; # Sch=pio[36]
 set_property -dict {PACKAGE_PIN V4  IOSTANDARD LVCMOS33} [get_ports redled4]       ; # Sch=pio[37]
...
#set_property -dict {PACKAGE_PIN U3  IOSTANDARD LVCMOS33} [get_ports { }]           ; # Sch=pio[44]
 set_property -dict {PACKAGE_PIN U7  IOSTANDARD LVCMOS33} [get_ports pio_usb_ovr]   ; # Sch=pio[45]
 set_property -dict {PACKAGE_PIN W7  IOSTANDARD LVCMOS33} [get_ports pio_usb_sel]   ; # Sch=pio[46]
 set_property -dict {PACKAGE_PIN U8  IOSTANDARD LVCMOS33} [get_ports spare_led2]    ; # Sch=pio[47]
 set_property -dict {PACKAGE_PIN V8  IOSTANDARD LVCMOS33} [get_ports blueled]       ; # Sch=pio[48]
