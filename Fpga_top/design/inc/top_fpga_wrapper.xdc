...
#set_property -dict {PACKAGE_PIN T1  IOSTANDARD LVCMOS33} [get_ports { pio[24] }]; # Sch=pio[29]
 ...
 set_property -dict {PACKAGE_PIN W7  IOSTANDARD LVCMOS33} [get_ports blu_led]    ; # Sch=pio[46]
 set_property -dict {PACKAGE_PIN U8  IOSTANDARD LVCMOS33} [get_ports grn_led]    ; # Sch=pio[47]
 set_property -dict {PACKAGE_PIN V8  IOSTANDARD LVCMOS33} [get_ports red_led]    ; # Sch=pio[48]
