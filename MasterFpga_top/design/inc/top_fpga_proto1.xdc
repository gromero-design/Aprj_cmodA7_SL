...
#set_property -dict {PACKAGE_PIN C15 IOSTANDARD LVCMOS33} [get_ports pio[05]]       ; # Sch=pio[05]
#set_property -dict {PACKAGE_PIN H1  IOSTANDARD LVCMOS33} [get_ports pio[06]]       ; # Sch=pio[06]
#set_property -dict {PACKAGE_PIN A15 IOSTANDARD LVCMOS33} [get_ports pio[07]]       ; # Sch=pio[07]
#set_property -dict {PACKAGE_PIN B15 IOSTANDARD LVCMOS33} [get_ports pio[08]]       ; # Sch=pio[08]
#set_property -dict {PACKAGE_PIN A14 IOSTANDARD LVCMOS33} [get_ports pio[09]]       ; # Sch=pio[09]
#set_property -dict {PACKAGE_PIN J3  IOSTANDARD LVCMOS33} [get_ports pio[10]]       ; # Sch=pio[10]
#set_property -dict {PACKAGE_PIN J1  IOSTANDARD LVCMOS33} [get_ports pio[11]]       ; # Sch=pio[11]
#set_property -dict {PACKAGE_PIN K2  IOSTANDARD LVCMOS33} [get_ports pio[12]]       ; # Sch=pio[12]
#set_property -dict {PACKAGE_PIN L1  IOSTANDARD LVCMOS33} [get_ports pio[13]]       ; # Sch=pio[13]
#set_property -dict {PACKAGE_PIN L2  IOSTANDARD LVCMOS33} [get_ports pio[14]]       ; # Sch=pio[14]
# ANALOG                                                                            ; # Sch=pio[15]
# ANALOG                                                                            ; # Sch=pio[16]
#set_property -dict {PACKAGE_PIN M1  IOSTANDARD LVCMOS33} [get_ports pio[17]]       ; # Sch=pio[17]
#set_property -dict {PACKAGE_PIN N3  IOSTANDARD LVCMOS33} [get_ports pio[18]]       ; # Sch=pio[18]
#set_property -dict {PACKAGE_PIN P3  IOSTANDARD LVCMOS33} [get_ports pio[19]]       ; # Sch=pio[19]
#set_property -dict {PACKAGE_PIN M2  IOSTANDARD LVCMOS33} [get_ports pio[20]]       ; # Sch=pio[20]
#set_property -dict {PACKAGE_PIN N1  IOSTANDARD LVCMOS33} [get_ports pio[21]]       ; # Sch=pio[21]
#set_property -dict {PACKAGE_PIN N2  IOSTANDARD LVCMOS33} [get_ports pio[22]]       ; # Sch=pio[22]
#set_property -dict {PACKAGE_PIN P1  IOSTANDARD LVCMOS33} [get_ports pio[23]]       ; # Sch=pio[23]
# VCC                                                                               ; # Sch=pio[24]
# GND                                                                               ; # Sch=pio[25]
#set_property -dict {PACKAGE_PIN R3  IOSTANDARD LVCMOS33} [get_ports pio[26]]       ; # Sch=pio[26]
#set_property -dict {PACKAGE_PIN T3  IOSTANDARD LVCMOS33} [get_ports pio[27]]       ; # Sch=pio[27]
#set_property -dict {PACKAGE_PIN R2  IOSTANDARD LVCMOS33} [get_ports pio[28]]       ; # Sch=pio[28]
#set_property -dict {PACKAGE_PIN T1  IOSTANDARD LVCMOS33} [get_ports pio[29]]       ; # Sch=pio[29]
#set_property -dict {PACKAGE_PIN T2  IOSTANDARD LVCMOS33} [get_ports pio[30]]       ; # Sch=pio[30]
#set_property -dict {PACKAGE_PIN U1  IOSTANDARD LVCMOS33} [get_ports pio[31]]       ; # Sch=pio[31]
#set_property -dict {PACKAGE_PIN W2  IOSTANDARD LVCMOS33} [get_ports pio[32]]       ; # Sch=pio[32]
#set_property -dict {PACKAGE_PIN V2  IOSTANDARD LVCMOS33} [get_ports pio[33]]       ; # Sch=pio[33]
#set_property -dict {PACKAGE_PIN W3  IOSTANDARD LVCMOS33} [get_ports pio[34]]       ; # Sch=pio[34]
#set_property -dict {PACKAGE_PIN V3  IOSTANDARD LVCMOS33} [get_ports pio[35]]       ; # Sch=pio[35]
#set_property -dict {PACKAGE_PIN W5  IOSTANDARD LVCMOS33} [get_ports pio[36]]       ; # Sch=pio[36]
#set_property -dict {PACKAGE_PIN V4  IOSTANDARD LVCMOS33} [get_ports pio[37]]       ; # Sch=pio[37]
#set_property -dict {PACKAGE_PIN U4  IOSTANDARD LVCMOS33} [get_ports pio[38]]       ; # Sch=pio[38]
#set_property -dict {PACKAGE_PIN V5  IOSTANDARD LVCMOS33} [get_ports pio[39]]       ; # Sch=pio[39]
#set_property -dict {PACKAGE_PIN W4  IOSTANDARD LVCMOS33} [get_ports pio[40]]       ; # Sch=pio[40]
#set_property -dict {PACKAGE_PIN U5  IOSTANDARD LVCMOS33} [get_ports pio[41]]       ; # Sch=pio[41]
#set_property -dict {PACKAGE_PIN U2  IOSTANDARD LVCMOS33} [get_ports pio[42]]       ; # Sch=pio[42]
#set_property -dict {PACKAGE_PIN W6  IOSTANDARD LVCMOS33} [get_ports pio[43]]       ; # Sch=pio[43]
#set_property -dict {PACKAGE_PIN U3  IOSTANDARD LVCMOS33} [get_ports pio[44]]       ; # Sch=pio[44]
#set_property -dict {PACKAGE_PIN U7  IOSTANDARD LVCMOS33} [get_ports pio[45]]       ; # Sch=pio[45]
set_property -dict {PACKAGE_PIN W7 IOSTANDARD LVCMOS33} [get_ports blueled]
set_property -dict {PACKAGE_PIN U8 IOSTANDARD LVCMOS33} [get_ports grnled]
set_property -dict {PACKAGE_PIN V8 IOSTANDARD LVCMOS33} [get_ports redled]
